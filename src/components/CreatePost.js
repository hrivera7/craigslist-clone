    ...
    <div className="auth-box create-post send-container">
      ...
      <div className="flexbox-column">
        ...
        />
            ...
            <div className="ui checkbox"><input onChange={handleChanges} 
        
        name="willDeliver" value={postData.willDeliver} type="checkbox" readonly="" tabindex="0"/><label>Will you deliver?</label></div>
